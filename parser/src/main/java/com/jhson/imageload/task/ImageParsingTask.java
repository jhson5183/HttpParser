 ...
 */
public class ImageParsingTask<Result> extends BaseAsyncTask<String, Void, List<Result>>{
    ...
    private List<Result> HttpParsingExecute(String httpUrl, HashMap<String, String> map) {
